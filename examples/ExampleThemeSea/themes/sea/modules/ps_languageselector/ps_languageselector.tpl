...
{* <div id="_desktop_language_selector">
  ...
  <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    {l s='Language' d='Shop.Theme.Global'} {$current_language.name_simple}
  </a>
  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        {foreach from=$languages item=language}
            <a class="dropdown-item {if $language.id_lang == $current_language.id_lang} active {/if}" data-iso-code="{$language.iso_code}" href="{url entity='language' id=$language.id_lang}">
            {$language.name_simple}
            </a>
      {/foreach}
  </div>