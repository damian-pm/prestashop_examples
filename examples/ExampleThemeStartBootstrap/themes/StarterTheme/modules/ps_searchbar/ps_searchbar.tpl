...
<div id="search_widget" class="search-widget" data-search-controller-url="{$search_controller_url}">
	...
	<form method="get"  class="form-inline my-2 my-md-0" action="{$search_controller_url}">
		<input type="hidden" name="controller" value="search">
		<input class="form-control mr-sm-2" name="s" value="{$search_string}" type="search" placeholder="Search" aria-label="Search">
