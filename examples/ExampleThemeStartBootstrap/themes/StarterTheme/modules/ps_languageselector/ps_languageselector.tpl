...
<div class="btn-group margin-s">
  <button type="button" class="btn btn-outline-primary btn-sm">{$current_language.name_simple}</button>
  ...
  <div class="dropdown-menu">
    {foreach from=$languages item=language}
      <a class="dropdown-item" href="{url entity='language' id=$language.id_lang}" data-iso-code="{$language.iso_code}">{$language.name_simple}</a>
  {/foreach}
